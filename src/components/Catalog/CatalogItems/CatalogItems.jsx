...
export default function CatalogItems({ catalog }) {
  ...
  const arrStar = [
    ...
    { id: 2, left: '1105px', top: '432px', backgroundColor: '#5500FF' },
    { id: 3, left: '1858px', top: '736px', backgroundColor: '#5500FF' },
    { id: 4, left: '648px', top: '947px', backgroundColor: '#49D2A4' },
    { id: 5, left: '172px', top: '1025px', backgroundColor: '#5500FF' },
    { id: 6, left: '52px', top: '1448px', backgroundColor: '#49D2A4' },
    { id: 7, left: '1105px', top: '1752px', backgroundColor: '#5500FF' },
    { id: 8, left: '1858px', top: '1963px', backgroundColor: '#5500FF' },
    { id: 9, left: '648px', top: '2041px', backgroundColor: '#49D2A4' },
    { id: 10, left: '172px', top: '2464px', backgroundColor: '#5500FF' },
    { id: 11, left: '52px', top: '2887px', backgroundColor: '#49D2A4' },
    { id: 12, left: '1105px', top: '3191px', backgroundColor: '#5500FF' },
    { id: 13, left: '1858px', top: '3402px', backgroundColor: '#5500FF' },
    { id: 14, left: '648px', top: '3480px', backgroundColor: '#49D2A4' },
    { id: 15, left: '172px', top: '3903px', backgroundColor: '#5500FF' },
    { id: 16, left: '52px', top: '4207px', backgroundColor: '#49D2A4' },
    { id: 17, left: '1105px', top: '4418px', backgroundColor: '#5500FF' },
    { id: 18, left: '1858px', top: '4496px', backgroundColor: '#5500FF' },
    { id: 19, left: '648px', top: '4919px', backgroundColor: '#49D2A4' },
    { id: 20, left: '172px', top: '5223px', backgroundColor: '#5500FF' },
  ];
