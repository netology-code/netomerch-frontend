...
const mockData = [
  ...
  },
  {
    ...
    answer: 'Одежду, которую вы не использовали, можно обменять или вернуть в течение двух недель со дня её получения. Напишите в службу поддержки support@...... — мы свяжемся с вами и поможем решить проблему.',
    isOpen: false,
  },
  {
    id: 5,
