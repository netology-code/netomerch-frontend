      ...
      <div className={styles.madeByBody}>
        ...
        <div className={styles.madeByDescription}>
          ...
          <p className={styles.madeByText}>
            ...
            Мы работали над ним несколько месяцев: прожили каждый этап его разработки, продумали дизайн каждой вещи и запустили сайт. Так мы хотим поддержать и вдохновить всех, кто продолжает учиться, начал карьеру <br /> в новой сфере или уже достиг успеха. Ребята, у вас всё получится!
          </p>
